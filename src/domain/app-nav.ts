...
export const MODULE_TITLES: Record<AppModuleId, { title: string; subtitle: string }> = {
  ...
  "finance-desk": { title: "Finance Desk", subtitle: "C1A — application through booking intent" },
  "booking-billing": { title: "Booking & Billing", subtitle: "C2 — booking through PDI" },
  "delivery-desk": { title: "Delivery Desk", subtitle: "C3 — payment through lifecycle activation" },
